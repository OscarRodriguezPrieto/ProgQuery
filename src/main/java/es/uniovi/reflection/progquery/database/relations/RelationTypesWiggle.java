...
public enum RelationTypesWiggle implements RelationTypesInterface {
	CU_ENCLOSES,

	IS_SUBTYPE_EXTENDS, IS_SUBTYPE_IMPLEMENTS,

	HAS_CLASS_TYPEPARAMETERS, HAS_CLASS_EXTENDS, HAS_CLASS_IMPLEMENTS, HAS_CLASS_BODY, HAS_CLASS_MODIFIERS,
	...
	MEMBER_SELECT_EXPR, METHODINVOCATION_TYPE_ARGUMENTS, METHODINVOCATION_METHOD_SELECT, METHODINVOCATION_ARGUMENTS, CALLS,
