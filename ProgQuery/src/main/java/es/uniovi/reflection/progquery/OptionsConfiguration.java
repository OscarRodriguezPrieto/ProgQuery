...
public class OptionsConfiguration {
	...
	public static final String helpMessage = copyrightMessage + "\nOptions:\n" +
		...
		"\t-list:<file_name>\n\t\tFor a large number of source files, list the file names in a file, separated by line breaks. (Short form:-l=<file_name>)\n" +
		"\t-classpath:<java_classpath>\n\t\tJava classpath, location of user-defined classes and packages. (Short form:-cp=<java_classpath>)\n" +
		"\tfile1.java ... fileN.java\n\t\tA non-empty list of file names.\n" +
	...
	public static final String[] listOptions = { "list", "l" };
