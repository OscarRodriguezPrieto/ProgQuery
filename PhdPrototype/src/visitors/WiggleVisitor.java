...
public class WiggleVisitor extends TreePathScanner<Void, Pair<Tree, RelationTypes>> {
	...
	public Void visitClass(ClassTree classTree, Pair<Tree, RelationTypes> t) {
		...
		scan(classTree.getMembers(), Pair.create((Tree) classTree, null));
		return null;
	...
	public Void visitCompilationUnit(CompilationUnitTree compilationUnitTree, Pair<Tree, RelationTypes> t) {
		...
		// DEFAULT
		Pair<Tree, RelationTypes> n = Pair.create((Tree) compilationUnitTree, RelationTypes.HAS_TYPE_DEC);
	...
	public Void visitConditionalExpression(ConditionalExpressionTree conditionalTree, Pair<Tree, RelationTypes> t) {
		...
		scan(conditionalTree.getCondition(), Pair.create((Tree) conditionalTree, RelationTypes.CONDITIONAL_EXPR_CONDITION));
		scan(conditionalTree.getTrueExpression(), Pair.create((Tree) conditionalTree, RelationTypes.CONDITIONAL_EXPR_THEN));
		scan(conditionalTree.getFalseExpression(), Pair.create((Tree) conditionalTree, RelationTypes.CONDITIONAL_EXPR_ELSE));
		return null;
	}
	...
	public Void visitExpressionStatement(ExpressionStatementTree expressionStatementTree, Pair<Tree, RelationTypes> t) {
		...
		if (!(expressionStatementTree.getExpression() instanceof LetExpr))
			scan(expressionStatementTree.getExpression(),
					Pair.create((Tree) expressionStatementTree, RelationTypes.ENCLOSES_EXPR));
