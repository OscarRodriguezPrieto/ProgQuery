...
public class WiggleIndexerPluginOld implements com.sun.source.util.Plugin {
    ...
    public void init(JavacTask task, String[] args) {
        ...
        task.addTaskListener(new AfterAnalyze(task, graphDbBuilder, cuProps));
//        task.addTaskListener(new ShutdownDBAfterAnalize(task, graphDbBuilder, cuProps));
