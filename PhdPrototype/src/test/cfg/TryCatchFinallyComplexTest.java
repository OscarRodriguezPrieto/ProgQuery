...
public class TryCatchFinallyComplexTest extends PluginBasedTestWithCommands {
	...
	public void test() {
		...
		assertNext(2, 45, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		...
		assertNext(6, 14, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		...
		assertNext(10, 18, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.VAR_DEC);
		assertNext(11, 12, CFGRelationTypes.CFG_NEXT_STATEMENT, NodeTypes.VAR_DEC);
		assertNext(11, 14, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		...
		assertNext(14, 17, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		...
		assertNext(17, 21, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		...
		assertNext(21, 45, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		...
		assertNext(27, 36, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.FINALLY_BLOCK);
		assertNext(28, 29, CFGRelationTypes.CFG_NEXT_STATEMENT_IF_TRUE, NodeTypes.IF_STATEMENT);
		assertNext(28, 36, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.FINALLY_BLOCK);
		...
		assertNext(40, 46, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.VAR_DEC);
		...
		assertNext(42, 49, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.VAR_DEC);
		assertNext(43, 61, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.FINALLY_BLOCK);

		assertNext(lastStatFinally, 26, CFGRelationTypes.NO_EXCEPTION, NodeTypes.EXPRESSION_STATEMENT);
		assertNext(lastStatFinally, 45, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		...
		assertNext(44, 45, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		assertNext(45, 46, CFGRelationTypes.CAUGHT_EXCEPTION, NodeTypes.VAR_DEC);
		assertNext(45, 48, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		...
		assertNext(48, 61, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.FINALLY_BLOCK);
		...
		assertNext(54, 60, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.FINALLY_BLOCK);
		...
		assertNext(lastStatFinally, 61, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.FINALLY_BLOCK);
		...
		assertNext(63, 70, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CATCH_BLOCK);
		assertNext(64, 65, CFGRelationTypes.CFG_NEXT_STATEMENT_IF_TRUE, NodeTypes.EXPRESSION_STATEMENT);
		assertNext(64, 71, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.VAR_DEC);
		...
		assertNext(69, 71, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.VAR_DEC);
		assertNext(70, 71, CFGRelationTypes.CAUGHT_EXCEPTION, NodeTypes.VAR_DEC);
		assertNext(70, 73, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.FINALLY_BLOCK);
		...
		Node exceptionalEnd = TestUtils.assertHasNextWith(nodesToTest.get(74), CFGRelationTypes.UNCAUGHT_EXCEPTION,
		...
		assertNext(lastStatFinally, exceptionalEnd, CFGRelationTypes.UNCAUGHT_EXCEPTION, NodeTypes.CFG_EXCEPTIONAL_END);
